...
Circle::Circle(const Vector2D<float> &_position, const SVGColor &fillColor, const SVGColor &strokeColor, float strokeWidth, float radius) : Ellipse(_position, fillColor, strokeColor, strokeWidth, Vector2D<float>(radius, radius)) {};
