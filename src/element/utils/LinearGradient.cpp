...
LinearGradient::LinearGradient(const string &id, const vector<string> &transforms, const string &units) : Gradient(id, transforms, units) {
	pos[0] = Vector2D<float>();
	pos[1] = Vector2D<float>(1.0f, 0.0f);
}

LinearGradient::LinearGradient(const string &id, const vector<string> &transforms, const string &units, const Vector2D<float> &_pos1, const Vector2D<float> &_pos2) : Gradient(id, transforms, units) {
	pos[0] = _pos1;
	pos[1] = _pos2;
}
