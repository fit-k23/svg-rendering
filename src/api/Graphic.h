...
#include "../element/shape/path/PathPoint.h"
#include "../element/shape/path/NormPathPoint.h"
#include "../element/shape/path/QuadPathPoint.h"
#include "../element/shape/path/CubicPathPoint.h"
#include "../element/shape/path/ArcPathPoint.h"
